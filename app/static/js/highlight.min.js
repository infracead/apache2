...
! function(e) {
    ...
    function f(e, t, r) {
        ...
        function c(e) {
            n += "<" + b(e) + u.map.call(e.attributes, function(e) {
                return " " + e.nodeName + '="' + k(e.value).replace('"', "&quot;") + '"'
            }).join("") + ">"
        }
        ...
        for (; e.length || t.length;) {
            var d = s();
            if (n += k(r.substring(a, d[0].offset)), a = d[0].offset, d === e) {
    ...
    function m(t) {
        return t.v && !t.cached_variants && (t.cached_variants = t.v.map(function(e) {
            ...
            starts: t.starts ? d(t.starts) : null
        })] : [t]
    }
    ...
    function _(t, a) {
        var n = {};
        return "string" == typeof t ? r("keyword", t) : i(t).forEach(function(e) {
            r(e, t[e])
        }), n;
    ...
    function E(a) {
        ...
        function n(n) {
            ...
            r.compiled || (r.compiled = !0, r.k = r.k || r.bK, r.k && (r.k = _(r.k, a.cI)), r.lR = u(r.l || /\w+/, !0), e && (r.bK && (r.b = "\\b(" + r.bK.split(" ").join("|") + ")\\b"), r.b || (r.b = /\B|\b/), r.bR = u(r.b), r.endSameAsBegin && (r.e = r.b), r.e || r.eW || (r.e = /\B|\b/), r.e && (r.eR = u(r.e)), r.tE = d(r.e) || "", r.eW && e.tE && (r.tE += (r.e ? "|" : "") + e.tE)), r.i && (r.iR = u(r.i)), null == r.relevance && (r.relevance = 1), r.c || (r.c = []), r.c = Array.prototype.concat.apply([], r.c.map(function(e) {
                return m("self" === e ? r : e)
    ...
    function M(e, n, i, t) {
        ...
        function c(e, t, r, a) {
            if (!r && "" === t) return "";
            if (!e) return t;
            var n = '<span class="' + (a ? "" : x.classPrefix);
            return (n += e + '">') + t + (r ? "" : w)
        }
        ...
        function o() {
            m += null != p.sL ? function() {
                ...
                if (e && !N[p.sL]) return k(g);
                var t = e ? M(p.sL, g, !0, f[p.sL]) : C(g, p.sL.length ? p.sL : void 0);
                return 0 < p.relevance && (_ += t.relevance), e && (f[p.sL] = t.top), c(t.language, t.value, !1, !0)
            }() : function() {
                var e, t, r, a, n, i, s;
                if (!p.k) return k(g);
                for (a = "", t = 0, p.lR.lastIndex = 0, r = p.lR.exec(g); r;) a += k(g.substring(t, r.index)), n = p, i = r, void 0, s = b.cI ? i[0].toLowerCase() : i[0], (e = n.k.hasOwnProperty(s) && n.k[s]) ? (_ += e[1], a += c(e[0], k(r[0]))) : a += k(r[0]), t = p.lR.lastIndex, r = p.lR.exec(g);
                return a + k(g.substr(t))
            }(), g = ""
        }
        ...
        function d(e) {
            ...
            }(t)), r.skip ? g += t : (r.eB && (g += t), o(), r.rB || r.eB || (g = t)), l(r), r.rB ? 0 : t.length
        }
        var u = {};

        function r(e, t) {
            var r = t && t[0];
            if (g += e, null == r) return o(), 0;
            if ("begin" == u.type && "end" == t.type && u.index == t.index && "" === r) return g += n.slice(t.index, t.index + 1), 1;
            if ("begin" === (u = t).type) return d(t);
            if ("illegal" === t.type && !i) throw new Error('Illegal lexeme "' + r + '" for mode "' + (p.cN || "<unnamed>") + '"');
            if ("end" === t.type) {
                var a = function(e) {
                    var t = e[0],
                        r = s(p, t);
                    if (r) {
                        var a = p;
                        for (a.skip ? g += t : (a.rE || a.eE || (g += t), o(), a.eE && (g = t)); p.cN && (m += w), p.skip || p.sL || (_ += p.relevance), (p = p.parent) !== r.parent;);
                        return r.starts && (r.endSameAsBegin && (r.starts.eR = r.eR), l(r.starts)), a.rE ? 0 : t.length
                    }
                }(t);
                if (null != a) return a
            }
        ...
        var g = "",
            _ = 0;
        try {
            for (var h, v, y = 0; p.t.lastIndex = y, h = p.t.exec(n);) v = r(n.substring(y, h.index), h), y = h.index + v;
            for (r(n.substr(y)), a = p; a.parent; a = a.parent) a.cN && (m += w);
            return {
                relevance: _,
                value: m,
                i: !1,
    ...
    function C(r, e) {
        ...
        var a = {
            ...
            n = a;
        return e.filter(B).filter(R).forEach(function(e) {
            var t = M(e, r, !1);
    ...
    function h(e) {
        return x.tabReplace || x.useBR ? e.replace(r, function(e, t) {
            return x.useBR && "\n" === e ? "<br>" : x.tabReplace ? t.replace(/\t/g, x.tabReplace) : ""
        }) : e
    }

    function v(e) {
        var t, r, a, n, i, s = function(e) {
            var t, r, a, n, i = e.className + " ";
            if (i += e.parentNode ? e.parentNode.className : "", r = o.exec(i)) return B(r[1]) ? r[1] : "no-highlight";
            for (t = 0, a = (i = i.split(/\s+/)).length; t < a; t++)
                if (l(n = i[t]) || B(n)) return n
        }(e);
        l(s) || (x.useBR ? (t = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n") : t = e, i = t.textContent, a = s ? M(s, i, !0) : C(i), (r = p(t)).length && ((n = document.createElementNS("http://www.w3.org/1999/xhtml", "div")).innerHTML = a.value, a.value = f(r, p(n), i)), a.value = h(a.value), e.innerHTML = a.value, e.className = function(e, t, r) {
            var a = t ? c[t] : r,
                n = [e.trim()];
    ...
    return n.highlight = M, n.highlightAuto = C, n.fixMarkup = h, n.highlightBlock = v, n.configure = function(e) {
        x = d(x, e)
    }, n.initHighlighting = y, n.initHighlightingOnLoad = function() {
        addEventListener("DOMContentLoaded", y, !1), addEventListener("load", y, !1)
    }, n.registerLanguage = function(t, e) {
        var r = N[t] = e(n);
        g(r), r.rawDefinition = e.bind(null, n), r.aliases && r.aliases.forEach(function(e) {
            c[e] = t
        })
    }, n.listLanguages = function() {
        return i(N)
    }, n.getLanguage = B, n.autoDetection = R, n.inherit = d, n.IR = n.IDENT_RE = "[a-zA-Z]\\w*", n.UIR = n.UNDERSCORE_IDENT_RE = "[a-zA-Z_]\\w*", n.NR = n.NUMBER_RE = "\\b\\d+(\\.\\d+)?", n.CNR = n.C_NUMBER_RE = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", n.BNR = n.BINARY_NUMBER_RE = "\\b(0b[01]+)", n.RSR = n.RE_STARTERS_RE = "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~", n.BE = n.BACKSLASH_ESCAPE = {
        b: "\\\\[\\s\\S]",
        relevance: 0
        ...
        return {
            ...
            c: [{
                ...
                b: /^#!/,
                e: /$/
            }, e.ASM, e.QSM, i, s, c, e.CLCM, e.CBCM, a, {
                b: /[{,\n]\s*/,
                relevance: 0,
                c: [{
                    b: t + "\\s*:",
